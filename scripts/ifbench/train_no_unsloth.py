"""
CUDA_VISIBLE_DEVICES=1 python scripts/ifbench/train_no_unsloth.py 2>&1 | tee logs/ifbench/train_no_unsloth.log
...
# Patch: TRL 0.24 expects vllm.sampling_params.GuidedDecodingParams which doesn't exist in vLLM 0.17
import vllm.sampling_params as _vllm_sp
if not hasattr(_vllm_sp, "GuidedDecodingParams"):
    _vllm_sp.GuidedDecodingParams = None

from trl.trainer import GRPOConfig, GRPOTrainer  # noqa: E402
...
LOG_FILE = "logs/ifbench/train_no_unsloth.log"
